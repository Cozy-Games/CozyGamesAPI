...
package com.github.cozygames.bukkit.command.type.api.play;
...
public class JoinCommand implements CommandType {

    private final @NotNull CozyGames api;

    public JoinCommand(@NotNull CozyGames api) {
        this.api = api;
    }
    ...
    public @Nullable String getSyntax() {
        return "/[parent] [name] [game_identifier]";
    }

    @Override
    public @Nullable String getDescription() {
        return "Used to join a specific game.";
    }
    ...
    public @Nullable CommandSuggestions getSuggestions(@NotNull User user, @NotNull ConfigurationSection configurationSection, @NotNull CommandArguments commandArguments) {
        return new CommandSuggestions().append(this.api.getAvaliableGame);
    }
